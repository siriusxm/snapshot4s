...
object generated {
  implicit val snapshotConfig: SnapshotConfig = new SnapshotConfig(
    resourceDirectory = Path("$tripleQuote${snapshot4sResourceDirectory.value}$tripleQuote"),
    outputDirectory = Path("$tripleQuote${snapshot4sDirectory.value}$tripleQuote"),
    sourceDirectory = Path("$tripleQuote${sourceBaseDirectory(
