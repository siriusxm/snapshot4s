        ...
        <div className="row">
          ...
          <div className={clsx('col col--3')}>
            <div className="text">
              ...
              <p>Snapshot4s automates the process of writing and updating tests, reducing the maintenance burden for developers.</p>
              ...
              <p>Want to learn more about snapshot testing? Check out our <a href="./intro">intro to learn more</a>.</p>
            </div>
          </div>
        </div>
      </div>
